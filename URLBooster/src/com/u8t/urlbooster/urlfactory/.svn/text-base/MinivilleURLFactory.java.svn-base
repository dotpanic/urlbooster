...
public class MinivilleURLFactory extends MinivilleLikeURLFactory {
    
    private static final String minivilleDomain = "miniville.fr";
    
    public MinivilleURLFactory(ExecutionUnit executionUnit, String miniville) {
